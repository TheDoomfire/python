...
source_dir = r"D:\Downloads\1 - Browser"
dest_dir_music = r"D:\Sounds\0 - Unsorted"
dest_dir_sfx = dest_dir_music
dest_dir_video = r"D:\Videos\0 - Unsorted"
dest_dir_image = r"D:\Pictures\0 - Unsorted"
dest_dir_documents = r"D:\Documents\0 - Unsorted"
dest_dir_other = r"D:\Downloads\0 - Unsorted"
...
# Other Files
other_extensions = [".exe", ".zip", ".xml", ".crdownload", ".torrent", ".msi", ".flp", ".rar", ".reg"]
...
class MoverHandler(FileSystemEventHandler):
    ...
    def check_document_files(self, entry, name):  # * Checks all Document Files
        for documents_extension in document_extensions:
            if name.endswith( ) or name.endswith(documents_extension.upper()):
